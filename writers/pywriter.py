...
class Pywriter():
    ...
    def openInitString(self):
        ...
        openInit += "from ask_sdk_core.handler_input import HandlerInput\n"
        openInit += "\n"
    ...
    def closeInitString(self):
        ...
        closeInit += "\t\tspeak_output = \"You can say hello to me!\"\n"
        closeInit += "\t\treprompt_text = \"How can I help?\"\n"
        closeInit += "\t\treturn (\n"
        closeInit += "\t\t\thandler_input.response_builder\n"
        closeInit += "\t\t\t\t.speak(speak_output)\n"
        closeInit += "\t\t\t\t.ask(reprompt_text)\n"
        closeInit += "\t\t\t\t.response\n"
        closeInit += "\t\t)\n"
        closeInit += "\n"
        closeInit += "\n"
